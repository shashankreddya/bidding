        ...
        <header id="header">
          <div class="inner">
            ...
            <nav id="nav" class="mobileUI-site-nav">
              <ul>
                <li class="current_page_item"><a href="adminhomepage.jsp">Home</a></li>
                <li> <a href="adminhomepage.jsp" class="arrow">Items</a>
                  <ul>
                    <li><a href="<%=request.getContextPath()%>/AddCategoryAction">Add Category</a></li>
                    <li><a href="<%=request.getContextPath()%>/AddCategoryAction?task=viewCategory">View Category</a></li>
                    <li><a href="<%=request.getContextPath()%>/AddItemsAction?task=categories">Add Items</a></li>
                    <li><a href="<%=request.getContextPath()%>/ViewItemsByAdmin">View Items</a></li>
                  </ul>
                </li>
                 <li> <a href="adminhomepage.jsp" class="arrow">BidItems</a>
                  <ul>
                ...
                <li><a href="<%=request.getContextPath()%>/ViewUsersAction">View Users</a></li>
                <li><a href="<%=request.getContextPath()%>/ViewWinners">View Winners</a></li>
                <li> <a href="adminhomepage.jsp" class="arrow">Transactions</a>
                  <ul>
                     <li><a href="<%=request.getContextPath()%>/ViewTransactions">View Transactions</a></li>
                     <li><a href="<%=request.getContextPath()%>/ViewFeedBackAction">View Feedback</a></li>
                  </ul>
                </li>
