        ...
        <header id="header">
          <div class="inner">
            ...
            <nav id="nav" class="mobileUI-site-nav">
              <ul>
                <li class="current_page_item"><a href="sellerhomepage.jsp">Home</a></li>
                <li> <a href="sellerhomepage.jsp" class="arrow">Items</a>
                  <ul>
                    <li><a href="<%=request.getContextPath()%>/AddItemsAction?task=categories">Add Items</a></li>
                    <li><a href="<%=request.getContextPath()%>/ViewAuctionDatesAction">View Auction dates</a></li>
                  </ul>
                </li>
                 <li> <a href="sellerhomepage.jsp" class="arrow">BidItems</a>
                  <ul>
               ...
               <li><a href="sellerhomepage.jsp" class="arrow">Messages</a>
				<ul>
