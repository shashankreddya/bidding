...
<title>End Today Auction Items</title>
</head>
<body>
	<c:choose>
	...
	<div align="center">
		<table align="center">
			<tr align="center">
				<th align="center"><h2>
						<font color="blue">End Today Auction Items </font>
					</h2></th>
			</tr>
			<tr>
			</tr>
			...
			<table align="center" border="1" bgcolor="">
				...
				<tr>
					...
					<td align="center"><select select name="cat" id="select"
						onchange="javascript:if(document.items.cat.value==''){alert('Select Category');}  {location.href='<%=request.getContextPath()%>/ViewCurrentBidItems?categoryName='+document.items.cat.value+'&check=endtoday';}">
